...
- My hypothetical theory based on pre -big bang scenario called Beyond the **Big bang-The theory of singularity displacemnnet **. it was published on OSF .you can check it out by  using this link
- [ https://osf.io/preprints/osf/nvqag_v1](url)
